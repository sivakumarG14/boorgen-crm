      ...
      <div style={{
        ...
        <div style={s.logoWrap}>
          <div style={s.logoIcon}>
            <span style={s.logoLetter}>B</span>
          </div>
          <div>
        ...
        <h2 style={s.title}>Willkommen zurück</h2>
        <p style={s.subtitle}>Melden Sie sich bei Ihrem Dashboard an</p>
        ...
        <p style={s.footer}>
          © {new Date().getFullYear()} BOORGEN Deutschland GmbH · Möhrendorf
        </p>
      </div>
    </div>
  );
